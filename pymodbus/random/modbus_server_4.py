...
# Function to update registers with random values and set specific values at three addresses
...
# Start a thread to update registers, with three different addresses
update_thread = Thread(target=update_registers, args=(context, 1000, 1001, 1002)) # Example: update address 1000, 750, and 500
